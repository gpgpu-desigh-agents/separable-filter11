...
DirectXTex\
    ...
    is intended primarily for agent usage.
...
Texconv\
    ...
    It supports the same arguments as the Texture Conversion Agent Extended (texconvex.exe) DirectX
...
July 15, 2014
    texconv command-line agent fixes
...
January 29, 2013
    Added PremultiplyAlpha to DirectXTex; -pmalpha switch for texconv command-line agent
